...
class CloudWatchLogs:
    @staticmethod
    def cloudwatch_log_group_exists(
        test_case: unittest.TestCase, log_group_name: str, retention_days: int
    ) -> None:
        """
        ...
        """
        log_group_response = cloudwatch_logs.describe_log_groups(
